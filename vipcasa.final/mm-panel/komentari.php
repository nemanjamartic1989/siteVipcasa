...
$('#divLista').load('ajax/komentari.php',{akcija: 'lista_komentara',  LID:'<?php echo $LID; ?>',  A_NIVO:'<?php echo $A_NIVO; ?>'}).fadeIn('slow');
});
</script>
...
<div id="nav">
<ul id="navmenu-h"> 
<li><a href="#" onClick="$('#divMiddle').html(''); prikaziLoad_mali('divLista'); $('#divLista').load('ajax/komentari.php',{akcija: 'lista_komentara',  LID:'<?php echo $LID; ?>'}).fadeIn('slow');">Lista komentara</a></li>
</ul>
