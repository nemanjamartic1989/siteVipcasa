...
$('#divLista').load('ajax/klijenti.php',{akcija: 'lista_klijenata',  LID:'<?php echo $LID; ?>',  A_NIVO:'<?php echo $A_NIVO; ?>'}).fadeIn('slow');
});
</script>
...
<div id="nav">
<ul id="navmenu-h"> 
                <li><a href="#" onClick="$('#divMiddle').html(''); prikaziLoad_mali('divLista'); $('#divLista').load('ajax/klijenti.php',{akcija: 'lista_klijenata',  LID:'<?php echo $LID; ?>'}).fadeIn('slow');">Users list</a></li>
         <li><a href="#" onClick="$('#divMiddle').html(''); prikaziLoad_mali('divAddEdit'); $('#divAddEdit').load('ajax/klijenti.php',{akcija: 'nov_klijent',  LID:'<?php echo $LID; ?>'}).fadeIn('slow');">New user</a></li>
</ul>
