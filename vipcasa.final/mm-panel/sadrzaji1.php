...
echo "<thead><tr class=\"TD_OddRed\"><th class=\"klasicno\">ID</th><th class=\"klasicno\">type</th><th class=\"klasicno\">content title</th><th class=\"klasicno\">searchable</th><th class=\"klasicno\">last change</th><th>&nbsp;</th></tr></thead><tbody>";
...
echo "<td class=\"klasicno\"><a class=\"meni\" href=\"./index.php?modul=sadrzaji&akcija=novi&id_elementa=$id_elementa&LID=$LID\">[view/change]</a></td>";
...
if($akcija == 'novi'){
?>
<script src="/mm-panel/ckeditor/ckeditor.js"></script>
 <script type="text/javascript" charset="utf-8">
 $().ready(function() {
  CKEDITOR.replace('sadrzaj',
    {
        filebrowserBrowseUrl : '/mm-panel/ckeditor/filemanager/browser/default/browser.html',
        filebrowserUploadUrl : '/mm-panel/ckeditor/filemanager/upload/upload.php'
    });
  })
 </script>
<?php
...
echo "<tr><td class=\"TD_EvenNew\" style=\"padding: 10px 5px 10px 10px\"><div id=\"submitDIV\"><input type=\"submit\" value=\"Accept changes\"> ";
if($id_elementa){echo " &nbsp; &nbsp; &nbsp; &nbsp;<input type=\"button\" value=\"Delete content\" onclick=\"if(confirm('Upozorenje!!\\nDelete?')){window.location='./index.php?modul=$modul&LID=$LID&akcija=obrisi&id_elementa=$id_elementa';}\">";}
