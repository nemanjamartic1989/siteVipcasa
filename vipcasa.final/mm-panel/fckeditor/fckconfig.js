...
FCKConfig.ToolbarComboPreviewCSS = 'style.css' ;
...
FCKConfig.ToolbarSets["Sweb"] = [
	['Source','Preview','-','Templates','Style'],
	['Cut','Copy','Paste','PasteText','PasteWord','-'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['TextColor','BGColor'],
	'/',
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Preview','Templates','Style','-','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','Undo','Redo','-','SpecialChar','Image', 'FitWindow'] 
] ;
