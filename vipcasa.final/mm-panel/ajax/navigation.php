...
if($akcija=='activate_nav_id_rus'){
    $navigation_id = $_REQUEST['navigation_id'];
    $sql_modify = "SELECT active FROM navigation_rus WHERE id = '$navigation_id' ";
    $rez_modify = mysql_query($sql_modify);
    if(mysql_num_rows($rez_modify)>0){
        list($id_nav)=@mysql_fetch_row($rez_modify);
        if($id_nav==1){
            $sql_modify = "UPDATE navigation_rus SET active=0 WHERE id = '$navigation_id' ";
            $rez_modify = mysql_query($sql_modify);
        }else{
            $sql_modify = "UPDATE navigation_rus SET active=1 WHERE id = '$navigation_id' ";
            $rez_modify = mysql_query($sql_modify);
        }
    }
}
...
if($akcija=='delete_first_level_item_rus'){
    $first_level_item_id = $_REQUEST['first_level_item_id'];
    $sql_modify = "DELETE FROM navigation_rus WHERE id = '$first_level_item_id' ";
    $rez_modify = mysql_query($sql_modify);
        if (!$rez_modify) {
            die('Greska: '.$sql_modify.' '. mysql_error());
        }  
$akcija='first_level_list_rus';
}
...
if($akcija=='delete_second_level_item_rus'){
    $first_level_item_id = $_REQUEST['first_level_item_id'];
    $id_par = $_REQUEST['id_par'];
    $sql_modify = "DELETE FROM navigation_rus WHERE id = '$first_level_item_id' ";
    $rez_modify = mysql_query($sql_modify);
...
?>
   <script>
$(document).ready(function(){ 
$('#second_level_list').load('ajax/navigation.php',{akcija: 'second_level_list_rus',  LID:'<?php echo $LID; ?>',  navigation_id:'<?php echo $id_par; ?>'}).fadeIn('slow');
});
</script>
   <?php
}
...
if($akcija=='delete_third_level_item_rus'){
    $first_level_item_id = $_REQUEST['first_level_item_id'];
    $id_par = $_REQUEST['id_par'];
    $sql_modify = "DELETE FROM navigation_rus WHERE id = '$first_level_item_id' ";
    $rez_modify = mysql_query($sql_modify);
...
?>
   <script>
$(document).ready(function(){ 
$('#third_level_list').load('ajax/navigation.php',{akcija: 'third_level_list_rus',  LID:'<?php echo $LID; ?>',  navigation_id:'<?php echo $id_par; ?>'}).fadeIn('slow');
});
</script>
   <?php
}
...
if($akcija=='insert_first_level_item_rus'){
   $new_first_level_item_val = $_REQUEST['new_first_level_item_val'];
   $sql_modify = "INSERT INTO navigation_rus (par, title, ord, active) VALUES ('0', '$new_first_level_item_val', '1', 0)";
     $rez_modify = mysql_query($sql_modify);
        if (!$rez_modify) {
            die('Greska: '.$sql_modify.' '. mysql_error());
                                 }   
...
if($akcija=='insert_second_level_item_rus'){
   $new_second_level_item_val = $_REQUEST['new_second_level_item_val'];
   $id_par = $_REQUEST['id_par'];
   $sql_modify = "INSERT INTO navigation_rus (par, title, ord, active) VALUES ('$id_par', '$new_second_level_item_val', '1', 0)";
     $rez_modify = mysql_query($sql_modify);
        if (!$rez_modify) {
            die('Greska: '.$sql_modify.' '. mysql_error());
                                 }   
...
if($akcija=='insert_third_level_item_rus'){
   $new_third_level_item_val = $_REQUEST['new_third_level_item_val'];
   $id_par = $_REQUEST['id_par'];
   $sql_modify = "INSERT INTO navigation_rus (par, title, ord, active) VALUES ('$id_par', '$new_third_level_item_val', '1', 0)";
     $rez_modify = mysql_query($sql_modify);
        if (!$rez_modify) {
            die('Greska: '.$sql_modify.' '. mysql_error());
                                 }   
...
<a href="#" title="Rename Item" onclick="$(\'#navigation_firstitem_title_val'.$navigation_id.'\').load(\'ajax/navigation.php\',{akcija: \'rename_first_level_item\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');"><img src="images/rename_nav.png" border=0></a><a href="#" title="Delete Item" onclick="pom = proveri(); if(pom){$(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'delete_third_level_item\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\',  id_par:\''.$navigation_parent.'\'}).fadeIn(\'slow\');}"><img src="images/close_nav.png" border=0></a></div></li>';
    ...
    echo '<div class="mmpanel-third-level-items-new"><input type="text" id="new_third_level_item_val" class="mmpanel_inpt_form"><input type="button" onclick="var new_third_level_item_val = $(\'#new_third_level_item_val\').val(); $(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'insert_third_level_item\',  LID:\''.$LID.'\',  id_par:\''.$navigation_parent.'\', new_third_level_item_val: new_third_level_item_val}).fadeIn(\'slow\');" name="btn_insert_new_firstlevel_item" value="Insert" class="btn"></div>';
}
...
<a href="#" title="Rename Item" onclick="$(\'#navigation_firstitem_title_val'.$navigation_id.'\').load(\'ajax/navigation.php\',{akcija: \'rename_first_level_item_eng\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');"><img src="images/rename_nav.png" border=0></a><a href="#" title="Delete Item" onclick="pom = proveri(); if(pom){$(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'delete_third_level_item_eng\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\',  id_par:\''.$navigation_parent.'\'}).fadeIn(\'slow\');}"><img src="images/close_nav.png" border=0></a></div></li>';
    ...
    echo '<div class="mmpanel-third-level-items-new"><input type="text" id="new_third_level_item_val" class="mmpanel_inpt_form"><input type="button" onclick="var new_third_level_item_val = $(\'#new_third_level_item_val\').val(); $(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'insert_third_level_item_eng\',  LID:\''.$LID.'\',  id_par:\''.$navigation_parent.'\', new_third_level_item_val: new_third_level_item_val}).fadeIn(\'slow\');" name="btn_insert_new_firstlevel_item" value="Insert" class="btn"></div>';
}

if($akcija=='third_level_list_rus'){
    $navigation_parent = $_REQUEST['navigation_id'];
    echo '<div class="mmpanel-third-level-header">3rd level</div>';
    //1st level listing
    $sql_level = "SELECT n.id, n.par, n.title, n.ord, n.link, n.active FROM navigation_rus n WHERE n.par=$navigation_parent ORDER BY n.ord";
    $rez_level = mysql_query($sql_level);
    if(mysql_num_rows($rez_level)>0){
     ?>
        <script type="text/javascript">
$(document).ready(function(){ 
    ...
    $(function() {
        $("#third_level_group ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
            var order = $(this).sortable("serialize") + '&action=updateRecordsListings&parent=<?php echo $navigation_parent; ?>'; 
            $.post("reorder/updateDB_nav3_rus.php", order, function(theResponse){
                //$("#first_level_group_result").html(theResponse);
            });                                                              
        }                                  
        });
   ...
   <script>
$(function(){ 
$( "#mmpanel-link-dialog-confirm_rus<?php echo $navigation_id; ?>" ).dialog({
            autoOpen: false,
            resizable: false,
            height:200,
            modal: true,
            buttons: {
                "Izmeni": function() {
                    var item_level_val = $('#item_level_val_rus<?php echo $navigation_id; ?>').val();
                    $('#first_level_list').load('ajax/navigation.php',{akcija: 'update_item_link_rus',  LID:'<?php echo $LID; ?>',  id_item:'<?php echo $navigation_id; ?>', item_level_val: item_level_val}).fadeIn('slow');
                    $(this).dialog("close");
                },
                "Odustani": function() {
                    $( this ).dialog( "close" );
...
$("#item-link_rus<?php echo $navigation_id; ?>").click(function() {
               $("#mmpanel-link-dialog-confirm_rus<?php echo $navigation_id; ?>").dialog("open");
            });


});
</script>
   <div id="mmpanel-link-dialog-confirm_rus<?php echo $navigation_id; ?>" title="Edit link">
    <p>Select a page</p>
<?php
    echo "<select class=\"izaberi\" id=\"id_strane\">";
...
?>
<p>Link:</p>
<input id="item_level_val_rus<?php echo $navigation_id; ?>" style="width: 270px;" type="text" value="<?php echo $navigation_link; ?>">
</div>
<?php
                    echo '<li id="mmpanel-third-level-items_'.$navigation_id.'" class="mmpanel-third-level-items"><div class="item-title" id="navigation_firstitem_title_val'.$navigation_id.'"><input type="checkbox" '.$active_state.' name="active_'.$navigation_id.'" onclick="$(\'#divAddEdit\').load(\'ajax/navigation.php\',{akcija: \'activate_nav_id_rus\',  LID:\''.$LID.'\', navigation_id:\''.$navigation_id.'\'}).fadeIn(\'slow\');" value="1" />&nbsp;&nbsp;<a href="#" title="'.$navigation_title.'" onclick="prikaziLoad_mali(\'third_level_list\'); $(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'third_level_list\',  LID:\''.$LID.'\', navigation_id:\''.$navigation_id.'\'}).fadeIn(\'slow\');">'.$navigation_title.'</a></div><div class="item-modify-icons"><a href="#" id="item-link_eng'.$navigation_id.'" title="Link Item"><img src="images/link_nav.png" border=0></a>
<a href="#" title="Rename Item" onclick="$(\'#navigation_firstitem_title_val'.$navigation_id.'\').load(\'ajax/navigation.php\',{akcija: \'rename_first_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');"><img src="images/rename_nav.png" border=0></a><a href="#" title="Delete Item" onclick="pom = proveri(); if(pom){$(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'delete_third_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\',  id_par:\''.$navigation_parent.'\'}).fadeIn(\'slow\');}"><img src="images/close_nav.png" border=0></a></div></li>';
    ...
    echo '<div class="mmpanel-third-level-items-new"><input type="text" id="new_third_level_item_val" class="mmpanel_inpt_form"><input type="button" onclick="var new_third_level_item_val = $(\'#new_third_level_item_val\').val(); $(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'insert_third_level_item_rus\',  LID:\''.$LID.'\',  id_par:\''.$navigation_parent.'\', new_third_level_item_val: new_third_level_item_val}).fadeIn(\'slow\');" name="btn_insert_new_firstlevel_item" value="Insert" class="btn"></div>';
}
...
if($akcija=='second_level_list_rus'){
    $navigation_parent = $_REQUEST['navigation_id'];
    echo '<div class="mmpanel-second-level-header">2nd level</div>';
    //2st level listing
    $sql_level = "SELECT n.id, n.par, n.title, n.ord, n.link, n.active FROM navigation_rus n WHERE n.par=$navigation_parent ORDER BY n.ord";
...
$(document).ready(function(){ 
    ...
    $(function() {
        $("#second_level_group ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
            var order = $(this).sortable("serialize") + '&action=updateRecordsListings&parent=<?php echo $navigation_parent; ?>'; 
            $.post("reorder/updateDB_nav2_rus.php", order, function(theResponse){
                //$("#first_level_group_result").html(theResponse);
            });                                                              
        }                                  
        });
...
<?php
                    echo '<li id="mmpanel-second-level-items-id_'.$navigation_id.'" class="mmpanel-second-level-items"><div class="item-title" id="navigation_firstitem_title_val'.$navigation_id.'"><input type="checkbox" '.$active_state.' name="active_'.$navigation_id.'" onclick="$(\'#divAddEdit\').load(\'ajax/navigation.php\',{akcija: \'activate_nav_id_rus\',  LID:\''.$LID.'\', navigation_id:\''.$navigation_id.'\'}).fadeIn(\'slow\');" value="1" />&nbsp;&nbsp;<a href="#" title="'.$navigation_title.'" onclick=" $(\'.mmpanel-second-level-items\').removeClass(\'mmpanel-second-level-items-active\').addClass(\'mmpanel-second-level-items\'); $(\'#mmpanel-second-level-items-id_'.$navigation_id.'\').addClass(\'mmpanel-second-level-items-active\');prikaziLoad_mali(\'third_level_list\'); $(\'#third_level_list\').load(\'ajax/navigation.php\',{akcija: \'third_level_list_rus\',  LID:\''.$LID.'\', navigation_id:\''.$navigation_id.'\'}).fadeIn(\'slow\');">'.$navigation_title.'</a></div><div class="item-modify-icons"><a href="#" id="item-link_rus'.$navigation_id.'" title="Link Item"><img src="images/link_nav.png" border=0></a>
<a href="#" title="Rename Item" onclick="$(\'#navigation_firstitem_title_val'.$navigation_id.'\').load(\'ajax/navigation.php\',{akcija: \'rename_first_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');"><img src="images/rename_nav.png" border=0></a><a href="#" title="Delete Item" onclick="pom = proveri(); if(pom){$(\'#second_level_list\').load(\'ajax/navigation.php\',{akcija: \'delete_second_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\',  id_par:\''.$navigation_parent.'\'}).fadeIn(\'slow\');}"><img src="images/close_nav.png" border=0></a></div></li>';
    ...
    echo '<div class="mmpanel-second-level-items-new"><input type="text" id="new_second_level_item_val" class="mmpanel_inpt_form"><input type="button" onclick="var new_second_level_item_val = $(\'#new_second_level_item_val\').val(); $(\'#second_level_list\').load(\'ajax/navigation.php\',{akcija: \'insert_second_level_item_rus\',  LID:\''.$LID.'\',  id_par:\''.$navigation_parent.'\', new_second_level_item_val: new_second_level_item_val}).fadeIn(\'slow\');" name="btn_insert_new_firstlevel_item" value="Insert" class="btn"></div>';
}
...
if($akcija=='update_item_link_rus'){
   $item_level_val = $_REQUEST['item_level_val'];
   $id_item = $_REQUEST['id_item'];
   $sql_modify = "UPDATE navigation_rus SET link='$item_level_val' WHERE id='$id_item' ";
   $rez_modify = mysql_query($sql_modify);
        if (!$rez_modify) {
            die('Greska: '.$sql_modify.' '. mysql_error());
                                 }    
...
if($akcija=='rename_first_level_item_rus'){
   ...
   $first_level_item_id = $_REQUEST['first_level_item_id'];
                           ...
                           var  text_rename_item = $('#rename_item_val');
                            ...
                            text_rename_item.keypress(function(e)
                            {
                                ...
                                if (code == 13)
                                {
                                        var text_rename_item = $('#rename_item_val').val();
                                        var id_item = '<?php echo $first_level_item_id; ?>';
                                        $('#navigation_firstitem_title_val<?php echo $first_level_item_id; ?>').load('ajax/navigation.php',{akcija: 'update_rename_item_rus',  LID:'<?php echo $LID; ?>',  text_rename_item: text_rename_item,  id_item: id_item}).fadeIn('slow');
                                }else{
    ...
    <?php
    $sql_level = "SELECT n.title FROM navigation_rus n WHERE n.id=$first_level_item_id ORDER BY n.ord";
    $rez_level = mysql_query($sql_level);
    if(mysql_num_rows($rez_level)>0){
            list($navigation_title)=@mysql_fetch_row($rez_level);
    echo '<input type="text" id="rename_item_val" class="mmpanel_inpt_form" value="'.$navigation_title.'">';
...
if($akcija=='update_rename_item_rus'){
    $text_rename_item = $_REQUEST['text_rename_item'];
    $id_item = $_REQUEST['id_item'];
    $sql_modify = "UPDATE navigation_rus SET title='$text_rename_item' WHERE id='$id_item' ";
     $rez_modify = mysql_query($sql_modify);
        if (!$rez_modify) {
            die('Greska: '.$sql_modify.' '. mysql_error());
                                 }   
    echo '<a href="#" title="'.$navigation_title.'" onclick="prikaziLoad_mali(\'second_level_list\'); $(\'#second_level_list\').load(\'ajax/navigation.php\',{akcija: \'second_level_list_rus\',  LID:\''.$LID.'\', navigation_id:\''.$id_item.'\'}).fadeIn(\'slow\');">'.$text_rename_item.'</a>';
}
...
<a href="#" title="Rename Item" onclick="$(\'#navigation_firstitem_title_val'.$navigation_id.'\').load(\'ajax/navigation.php\',{akcija: \'rename_first_level_item_eng\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');"><img src="images/rename_nav.png" border=0></a><a href="#" title="Delete Item" onclick="pom = proveri(); if(pom){$(\'#first_level_list\').load(\'ajax/navigation.php\',{akcija: \'delete_first_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');}"><img src="images/close_nav.png" border=0></a></div></li>';
    ...
    echo '<div class="mmpanel-first-level-items-new"><input type="text" id="new_first_level_item_val" class="mmpanel_inpt_form"><input type="button" onclick="var new_first_level_item_val = $(\'#new_first_level_item_val\').val(); $(\'#first_level_list\').load(\'ajax/navigation.php\',{akcija: \'insert_first_level_item_eng\',  LID:\''.$LID.'\', new_first_level_item_val: new_first_level_item_val}).fadeIn(\'slow\');" name="btn_insert_new_firstlevel_item" value="Insert" class="btn"></div>';
}

if($akcija=='first_level_list_rus'){
    echo '<div class="mmpanel-first-level-header">1st level</div>';
    //1st level listing
    $sql_level = "SELECT n.id, n.par, n.title, n.link, n.ord, n.active FROM navigation_rus n WHERE n.par=0 ORDER BY n.ord";
    $rez_level = mysql_query($sql_level);
    if(mysql_num_rows($rez_level)>0){
        ?>
        <script type="text/javascript">
$(document).ready(function(){ 
    ...
    $(function() {
        $("#first_level_group ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
            var order = $(this).sortable("serialize") + '&action=updateRecordsListings&parent=0'; 
            $.post("reorder/updateDB_nav_rus.php", order, function(theResponse){
                //$("#first_level_group_result").html(theResponse);
            });                                                              
        }                                  
        });
...
$("#item-link_rus<?php echo $navigation_id; ?>").click(function() {
   ...
   <div id="mmpanel-link-dialog-confirm_rus<?php echo $navigation_id; ?>" title="Link edit">
    <p>Select page</p>
<?php
    echo "<select class=\"izaberi\" id=\"id_strane\">";
...
<?php
                    echo '<li id="mmpanel-first-level-items-id_'.$navigation_id.'" class="mmpanel-first-level-items"><div class="item-title" id="navigation_firstitem_title_val'.$navigation_id.'"><input type="checkbox" '.$active_state.' name="active_'.$navigation_id.'" onclick="$(\'#divAddEdit\').load(\'ajax/navigation.php\',{akcija: \'activate_nav_id_rus\',  LID:\''.$LID.'\', navigation_id:\''.$navigation_id.'\'}).fadeIn(\'slow\');" value="1" />&nbsp;&nbsp;<a href="#" title="Click for 2nd level" onclick="$(\'#third_level_list\').html(\'\'); $(\'.mmpanel-first-level-items\').removeClass(\'mmpanel-first-level-items-active\').addClass(\'mmpanel-first-level-items\'); $(\'#mmpanel-first-level-items-id_'.$navigation_id.'\').addClass(\'mmpanel-first-level-items-active\'); prikaziLoad_mali(\'second_level_list\'); $(\'#second_level_list\').load(\'ajax/navigation.php\',{akcija: \'second_level_list_rus\',  LID:\''.$LID.'\', navigation_id:\''.$navigation_id.'\'}).fadeIn(\'slow\');">'.$navigation_title.'</a></div><div class="item-modify-icons"><a href="#" id="item-link_rus'.$navigation_id.'" title="Link Item"><img src="images/link_nav.png" border=0></a>
<a href="#" title="Rename Item" onclick="$(\'#navigation_firstitem_title_val'.$navigation_id.'\').load(\'ajax/navigation.php\',{akcija: \'rename_first_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');"><img src="images/rename_nav.png" border=0></a><a href="#" title="Delete Item" onclick="pom = proveri(); if(pom){$(\'#first_level_list\').load(\'ajax/navigation.php\',{akcija: \'delete_first_level_item_rus\',  LID:\''.$LID.'\', first_level_item_id: \''.$navigation_id.'\'}).fadeIn(\'slow\');}"><img src="images/close_nav.png" border=0></a></div></li>';
    ...
    echo '<div class="mmpanel-first-level-items-new"><input type="text" id="new_first_level_item_val" class="mmpanel_inpt_form"><input type="button" onclick="var new_first_level_item_val = $(\'#new_first_level_item_val\').val(); $(\'#first_level_list\').load(\'ajax/navigation.php\',{akcija: \'insert_first_level_item_rus\',  LID:\''.$LID.'\', new_first_level_item_val: new_first_level_item_val}).fadeIn(\'slow\');" name="btn_insert_new_firstlevel_item" value="Insert" class="btn"></div>';
}
...
if($akcija=='navigation_list'){
    ...
    echo '<div><h1>Serbian navigation</h1></div>';
...
if($akcija=='navigation_list_eng'){
    ...
    echo '<div><h1>English navigation</h1></div>';
    echo '<div class="mmpanel-navigation-list">';
...
if($akcija=='navigation_list_rus'){
    echo '<script>prikaziLoad_mali(\'first_level_list\'); $(\'#first_level_list\').load(\'ajax/navigation.php\',{akcija: \'first_level_list_rus\',  LID:\''.$LID.'\'}).fadeIn(\'slow\');</script>';
    echo '<div><h1>Russian navigation</h1></div>';
    echo '<div class="mmpanel-navigation-list">';
